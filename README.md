# FinPaa Coding Challenge 💻

Hello and welcome to the FinPaa Coding Challenge. Thank you for your interest in becoming part of our team. The purpose of this challenge is to give you a feeling for the tasks that await you at FinPaa and to familiarize you with our current stack.
...
- Create a database, name it 'FinPaa_coding_challenge'.
- Setup .env file
...
- Please check again if all requirements have been done as described. If there are things that need explanation, add them as a text message via email at hr@finpaa.com
